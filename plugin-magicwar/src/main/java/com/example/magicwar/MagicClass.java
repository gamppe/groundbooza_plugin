...
/** The three classes a player picks from when the arena opens. Each has three upgrade lines,
 * all placeholders for now - the layout is in place so the real upgrades can drop in. */
public enum MagicClass {
    ...
    MagicClass(String label, Material icon, String blurb, List<ClassTrack> tracks) {
        this.label = label;
        this.icon = icon;
        this.blurb = blurb;
        this.tracks = tracks;
