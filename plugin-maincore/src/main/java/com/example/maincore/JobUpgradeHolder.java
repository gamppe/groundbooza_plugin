...
/**
 * The anvil screen from /직업 (6 rows). Row 1 col 5 = job card; rows 2/4/6 each hold one
 * upgrade track: its icon in col 1 and MAX_LEVEL wool pips from col 3 (gray = not bought,
 * yellow = bought). Row 6 col 9 = back arrow.
 */
public class JobUpgradeHolder implements InventoryHolder {
